<?php
    ...
    if(isset($_REQUEST["btn_PlaceOrder"])) 
    {
        ...
        $qry= "INSERT INTO tbl_orderdetails (OMID, ProductId, Qty, Price) SELECT $OMId, tbl_cart.ProductId, tbl_cart.Qty, tbl_product.Price   FROM tbl_cart, tbl_product where tbl_cart.ProductId = tbl_product.ProductId and CustomerId=".$_SESSION["CustomerId"].";DELETE FROM tbl_Cart WHERE CustomerId=".$_SESSION["CustomerId"]
